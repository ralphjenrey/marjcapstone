...
<?php include_once('includes/header.php');?>
    ...
    <div class="container-xxl py-5 page-header position-relative mb-5">
        <div class="container py-5">
            <h1 class="display-2 text-white">Home</h1>
    ...
    <div class="container flex">
      <div class="left">
        ...
        <p>Cebu Eastern College (CEC) is a private, co-educational Chinese-Filipino school in Cebu City. 
            ...
            High School, founded in 1925. </p>
            <p>Provide further details on the About Us</p>
        <p>Source: cebueasterncollege.edu.ph</p>    
        <div>
    <button class="primary-btn" onclick="location.href='aboutus.php';">ABOUT US</button>
</div>


      </div>
      <div class="right">
      <img src="img/11.jpg" alt="" width="550" height="400">
      </div>
    </div>
  </section>
