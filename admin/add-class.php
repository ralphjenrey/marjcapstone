...
<!--   Class---->
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="classname" name="classname" placeholder="Course Name e.g: BSIT, BSHM, etc." required>
                  </div>
  ...
  <!--Class Pic---->
  <div class="form-group">
                    <label for="exampleInputFile">Course Picture <span style="font-size:12px;color:red;">(Only jpg / jpeg/ png /gif format allowed)</span></label>
