                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">COLLEGE DEPARTMENT REQUIREMENTS</h3>
                            </div>
                            <form method="post">
                                <div class="card-body">
                                    <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="contact_title" value="<?php echo isset($row['PageTitle']) ? htmlspecialchars($row['PageTitle']) : ''; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="contact_info">Details</label>
                                        <textarea name="contact_info" class="form-control" required cols="140" rows="10"><?php echo isset($row['PageDescription']) ? htmlspecialchars($row['PageDescription']) : ''; ?></textarea>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" name="submit_contact">Submit</button>
                                </div>
                            </form>
                        </div>
