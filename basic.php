    ...
    <div class="container custom-container mb-5">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h3 class="card-title">ACADEMIC STAGES</h3>
            </div>
            <div class="card-body">
                <table class="custom-table table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th class="degree-title">Basic Education</th>
                            <th class="action">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="degree-title">Kindergarden</td>
                            <td class="action">
                                <a href="req.php" title="View Details" class="btn btn-primary btn-sm">View</a>
                            </td>
                        </tr>
                        <tr>
                            <td class="degree-title">Elementary Education (Grade 1-6)</td>
                            <td class="action">
                                <a href="enrollment-details.php?enrollid=2" title="View Details" class="btn btn-primary btn-sm">View</a>
                            </td>
                        </tr>
                        <tr>
                            <td class="degree-title">Junior High School (Grade 7-10)</td>
                            <td class="action">
                                <a href="enrollment-details.php?enrollid=2" title="View Details" class="btn btn-primary btn-sm">View</a>
                            </td>
                        </tr>
